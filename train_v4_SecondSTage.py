...
'''
"""Here is the training script for the second stage of training."""
...
# two stage training
parser.add_argument("--stage_change", type=int, default=False, help="stage1: only using focal and contextual loss")
